...
namespace TrabajoFinalRestaurante.Repository
{
    public class ReservaRepository : IReservaRepository
    {
        ...
        public async Task<List<CuposResult>> TurnosPorFechaRepository(DateTime FechaReserva)
        {
            ...
            var turnosLibres = result.Select(r => new CuposResult
            {
        ...
        public async Task<List<CuposResult>> TurnosSinCuposRepository()
        {
